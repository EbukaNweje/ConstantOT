...
function Withdrawal() {
  ...
  console.log(userName, email)
    ...
    const handleAmount = (e) => {
      ...
      const urll = `https://constantot.onrender.com/api/userdata/${id}`
      const url = `https://constantot.onrender.com/api/requestwithdrawcode/${id}`
      const urlll = `https://constantot.onrender.com/api/withdrawal`
