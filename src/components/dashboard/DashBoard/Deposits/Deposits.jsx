               ...
               <div className='Deposit_CardWrapper'>
                 <div className='Deposit_Amount'>
                    <div className='Amount_Top'>
                        ...
                        <input className='Amount_Input' type="text" placeholder='Enter Amount' onChange ={handleAmount} />
                    ...
                    <div className='Amount_Bot'>
                        ...
                        <div className='Choose_Div'>
                            ...
                            <div className='Transfer_Div'>
                                ...
                                <input type="radio" name="Wal" onChange={()=> {setEthereum(false), setBtc(true), setBnb(false), setDogecoin(false), setButtonDisabled(false)}}/>
                            </div>
                            <div className='Transfer_Bitcoin'>
                                <div className='Transfer_Div'>
                                ...
                                <input type="radio" name="Wal" onChange={()=> {setEthereum(true), setBtc(false), setBnb(false), setDogecoin(false), setButtonDisabled(false)}}/>
                            </div>
                            {/* <div className='Transfer_Bitcoin'>
                                <div className='Transfer_Div'>
                            ...
                            <div className='Transfer_Bitcoin'>
                                ...
                                <input type="radio" name="Wal"  onChange={()=> {setEthereum(false), setBtc(false), setBnb(false), setDogecoin(true), setButtonDisabled(false)}}/>
                            </div>
                            {/* <div className='Transfer_Bitcoin'>
                                <div className='Transfer_Div'>
                                ...
                                <input type="radio" name="Wal"  onChange={()=> {setEthereum(false), setBtc(false), setBnb(true), setDogecoin(false), setButtonDisabled(false)}}/>
                            </div> */}
                        </div>
                    </div>
